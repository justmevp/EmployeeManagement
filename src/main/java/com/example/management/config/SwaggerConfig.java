...
@Configuration
@OpenAPIDefinition(info = @Info(title = "Management API ", // Tiêu đề API
        ...
        ), termsOfService = "http://localhost:8080/swagger-ui/index.html", description = "Employee Management Demo by VP"))
